from ztl.dsl.component.experimental import container_component
from ztl.dsl.placeholder import placeholder as ph
...
if __name__ == '__main__':
    print(create_pipeline_component_instances("sample", "sample"))
