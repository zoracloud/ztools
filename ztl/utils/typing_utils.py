...
ArtifactMultiMap = MultiMap[str, ztl.types.Artifact]
ArtifactMutableMultiMap = MutableMultiMap[str, ztl.types.Artifact]
# Commonly used legacy artifact dict concrete type. Always prefer to use
# ArtifactMultiMap or ArtifactMutableMultiMap.
ArtifactMultiDict = Dict[str, List[ztl.types.Artifact]]
...
def is_homogeneous_artifact_list(value: Any) -> bool:
  ...
  return (
      is_compatible(value, Sequence[ztl.types.Artifact]) and
