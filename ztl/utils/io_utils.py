...
from ztl.dsl.io import fileio
from google.protobuf import json_format
from google.protobuf import text_format
from google.protobuf.message import Message

try:
  from ztl.proto.orchestration.tf_metadata.schema_pb2 import Schema as schema_pb2_Schema  # pylint: disable=g-import-not-at-top,g-importing-member
...
class SchemaReader:
  ...
  def read(self, schema_path: str) -> schema_pb2_Schema:  # pytype: disable=invalid-annotation
    ...
    """
    try:
      from ztl.proto.orchestration.tf_metadata.schema_pb2 import schema_pb2  # pylint: disable=g-import-not-at-top
    except ModuleNotFoundError as e:
